 ...
 * Demonstrates use of @EntryPoint of the Hilt library.
 */
class LogsContentProvider : ContentProvider() {
    ...
    //Uses the entry point interface we defined below in our LogsContentProviderEntryPoint class
    // to obtain the bindings we want to access, in our case, LogDao:
    private fun getLogDao(appContext: Context): LogDao {
        val hiltEntryPoint =
            EntryPointAccessors.fromApplication(appContext, LogsContentProviderEntryPoint::class.java)
    ...
    /**
     * An entry point is an interface with an accessor method for binding type we want:
     */
